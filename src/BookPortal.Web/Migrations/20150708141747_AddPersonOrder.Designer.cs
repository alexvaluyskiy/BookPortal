...
namespace BookPortalWebMigrations
{
    ...
    partial class AddPersonOrder
    {
        public override string Id
        {
            get { return "20150708141747_AddPersonOrder"; }
        }
            ...
            builder.Entity("BookPortal.Web.Domain.Models.Publisher", b =>
                {
                    ...
                    b.Property<DateTime?>("DateClose")
                        .Annotation("Relational:ColumnName", "date_close");

                    b.Property<DateTime?>("DateOpen")
                        .Annotation("Relational:ColumnName", "date_open");
